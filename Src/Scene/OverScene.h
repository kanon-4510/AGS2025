...
public:
	...
	static constexpr VECTOR PLAYER_SIZE = { 1.4f, 1.4f, 1.4f };
	static constexpr float LIGHT_SCALE_X = 1.3f;
	static constexpr float LIGHT_SCALE_Y = 2.05f;
	...
	static constexpr int MENU_POS_X = 1500;
