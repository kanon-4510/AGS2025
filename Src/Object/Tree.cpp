...
void Tree::DrawDebug(void)
{
	...
	v = pos_;
	DrawFormatString(20, 230, white, "ñÿÇÃç¿ïWÅF(%0.2f, %0.2f, %0.2f)ñÿÇÃèÛë‘LGHW(%d,%d,%d,%d)",
...
void Tree::eHit(void)//ÉGÉlÉ~Å[Ç∆ÇÃÇ†ÇΩÇËîªíË
{
	hp_ -= 1;
}
void Tree::pHit(void)//ÉvÉåÉCÉÑÅ[Ç∆ÇÃÇ†ÇΩÇËîªíË
{
	water_++;
}